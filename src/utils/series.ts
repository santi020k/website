...
export const sortSeriesPosts = <T extends SeriesPostLike>(posts: T[]) => [...posts].sort((a, b) => {
...
export const getAdjacentSeriesPosts = <T extends { id: string }>(posts: T[], currentPostId: string) => {
