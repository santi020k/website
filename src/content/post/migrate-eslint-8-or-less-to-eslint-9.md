...
coverImage:
  alt: "Illustration showing a migration from eslintrc to eslint.config.mjs"
...
![Diagram comparing a layered eslintrc setup with a more explicit flat config setup](./migrate-eslint-8-or-less-to-eslint-9-fig-1.png)
...
After migrating enough projects, I got tired of rebuilding the same frontend setup over and over again. That is why I moved my standards into [`@santi020k/eslint-config-basic`](https://eslint.santi020k.me/).
...
![Diagram showing a migration path from legacy eslint config to a reusable explicit flat config setup](./migrate-eslint-8-or-less-to-eslint-9-fig-2.png)
