...
seoTitle: "Vitest + React Testing Library Guide"
tags: ["vitest", "testing-library", "react", "typescript", "nextjs"]
coverImage:
  alt: "A component moving through interaction, targeting, state, and assertion checks toward verification"
  src: "./cover.webp"
postType: "Tutorial"
...
<PackageManagerCodeTabs
  ariaLabel="Choose a package manager to install the testing dependencies"
  commands={{
    npm: 'npm install --save-dev vitest jsdom @testing-library/react @testing-library/jest-dom @testing-library/user-event',
    yarn: 'yarn add --dev vitest jsdom @testing-library/react @testing-library/jest-dom @testing-library/user-event',
    pnpm: 'pnpm add --save-dev vitest jsdom @testing-library/react @testing-library/jest-dom @testing-library/user-event',
    bun: 'bun add --dev vitest jsdom @testing-library/react @testing-library/jest-dom @testing-library/user-event'
  }}
/>
