...
<PackageManagerCodeTabs
  ...
  commands={{
    ...
    yarn: 'yarn add --dev husky lint-staged',
    pnpm: 'pnpm add --save-dev husky lint-staged',
    bun: 'bun add --dev husky lint-staged'
  }}
/>
