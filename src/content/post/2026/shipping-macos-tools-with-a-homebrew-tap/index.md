...
Its first formula installs Santi020k Terminal from the larger [Santi020k Theme](/portfolio/santi020k-theme/) project.
...
The [Santi020k Homebrew Tap case study](/portfolio/homebrew-tap/) covers the project at a glance, and the [repository](https://github.com/santi020k/homebrew-tap) contains the current formula.
