...
Specialized guidance for this project is in `.Codex/skills/`:

- **[seo](.Codex/skills/seo/SKILL.md)** — Meta tags, structured data, sitemap, Core Web Vitals, image optimization
- **[marketing](.Codex/skills/marketing/SKILL.md)** — Copy, brand voice, CTAs, blog strategy, social media
- **[accessibility](.Codex/skills/accessibility/SKILL.md)** — WCAG 2.2 AA, ARIA, keyboard nav, Alpine.js a11y patterns
- **[web-design](.Codex/skills/web-design/SKILL.md)** — Design system, Tailwind tokens, animations, Alpine transitions, dark mode

Codex agent skills are in `.agent/skills/` (adding content, creating components, testing, etc.).
