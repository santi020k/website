...
Fonts:
    Uses Montserrat (same font as the website) from public/fonts/.
    The Montserrat-Bold.ttf is generated from the variable font — run
    scripts/generate-fonts.py once if it is missing.

ATS notes:
    • Linear single-column layout — no multi-column text blocks.
    • All text is selectable (not rasterised).
    • Standard section names (Experience, Projects, Skills & Interests).
    • PDF metadata set for applicant-tracking-system parsing.
    • No images, headers, or footers that could confuse parsers.
"""
...
# ── Register Montserrat (same typeface as the website) ────────────────────────
_REG = FONTS_DIR / "Montserrat-Regular.ttf"
_BOLD = FONTS_DIR / "Montserrat-Bold.ttf"      # generated by scripts/generate-fonts.py
_ITALIC = FONTS_DIR / "montserrat-italic-variable-font-wght.ttf"

pdfmetrics.registerFont(TTFont("Montserrat", str(_REG)))
pdfmetrics.registerFont(TTFont("Montserrat-Bold", str(_BOLD)))
pdfmetrics.registerFont(TTFont("Montserrat-Italic", str(_ITALIC)))
...
INK_MID = colors.HexColor("#444444")
...
def build_styles() -> dict[str, ParagraphStyle]:
    return {
        ...
        "co_name": _s(
            ...
            fontName="Montserrat-Bold",
            fontSize=SZ["company"],
            leading=SZ["company"] * 1.35,
            alignment=TA_LEFT,
            textColor=INK,
        ),
        # Location (right) — regular
        "co_loc": _s(
            "co_loc",
            fontName="Montserrat",
            fontSize=SZ["company"],
        ...
        # Role title (left) — bold
        "role": _s(
            "role",
            fontName="Montserrat-Bold",
            fontSize=SZ["body"],
            leading=SZ["body"] * 1.35,
            alignment=TA_LEFT,
            textColor=INK,
        ),
        # Dates (right) — regular
        ...
        # Body text (summary paragraphs)
        "body": _s(
            "body",
            fontName="Montserrat",
            fontSize=SZ["body"],
            leading=SZ["body"] * 1.55,
            alignment=TA_LEFT,
            textColor=INK_MID,
            spaceAfter=5,
        ),
...
def two_col(left: Paragraph, right: Paragraph, split: float = 0.68) -> Table:
    """Return a full-width 2-cell table — left/right aligned, ATS-safe reading order."""
...
def experience(
    ...
    items: list = []
    items.append(two_col(Paragraph(company, s["co_name"]), Paragraph(location, s["co_loc"])))
    items.append(two_col(Paragraph(role, s["role"]), Paragraph(dates, s["dates"])))
    for b in bullets:
...
def build() -> None:
    doc = SimpleDocTemplate(
        ...
        topMargin=MARGIN,
        bottomMargin=MARGIN,
        # PDF metadata — improves ATS parsing and search
        title="Santiago Molina Orozco — CV",
        author="Santiago Molina Orozco",
        subject="Tech Lead | Full Stack Developer | React | TypeScript | Node.js",
        keywords="React, TypeScript, Node.js, Tech Lead, Full Stack, Frontend, Next.js, "
                 "React Native, NestJS, AWS, CI/CD, Agile, Scrum, JavaScript, Tailwind CSS",
        creator="scripts/generate-cv.py",
    )
    ...
    story += [
        ...
        rule(),
        Paragraph(
            "I\u2019m a Full Stack Developer and Tech Lead with over a decade of experience, "
            "specializing in <b>React, React Native, TypeScript and Node.js</b>, with a strong "
            "focus on front-end architecture and user experience. Currently working as a "
            "<b>Sr. Front End Developer at Smith Commerce</b>, I\u2019ve led high-impact, scalable "
            "projects for companies like <b>Void.GG</b>, aligning technical solutions with "
            "business goals.",
            s["body"],
        ),
        Paragraph(
            "As a <b>co-organizer of React JS Colombia Meetup</b>, I actively contribute to the "
            "tech community by fostering innovation, mentorship, and continuous learning. I\u2019m "
            "passionate about building products that not only perform but also empower teams to "
    ...
    story += experience(s,
        ...
        [
            ...
            "Architected scalable frontend foundations using Next.js 15, React 19, TypeScript, and "
            "Turborepo in a monorepo setup, enabling parallel front-end and back-end delivery "
            ...
            "<b>Tech Stack: Next.js \u00b7 React \u00b7 TypeScript \u00b7 Turborepo \u00b7 Tailwind CSS \u00b7 "
            "Radix UI \u00b7 TanStack Query \u00b7 Zustand \u00b7 Apollo Client \u00b7 Storybook \u00b7 "
            "Jest \u00b7 Playwright \u00b7 CI/CD \u00b7 AWS</b>",
        ],
    )
    ...
    story += experience(s,
        ...
        [
            ...
            "<b>Tech Stack: React \u00b7 React Native \u00b7 Node \u00b7 TypeScript \u00b7 GitHub Actions \u00b7 "
            "RTQ \u00b7 AWS \u00b7 Next.js \u00b7 NestJS \u00b7 Mantine</b>",
        ],
    )
    story.append(Spacer(1, 5))
    ...
    story += experience(s,
        ...
        [
            ...
            "<b>Tech Stack: React \u00b7 Node.js \u00b7 TypeScript \u00b7 AWS \u00b7 GCP \u00b7 MongoDB \u00b7 "
            "Socket.io \u00b7 Docker \u00b7 Angular \u00b7 Express</b>",
        ],
    )
    story.append(Spacer(1, 5))
    ...
    story += experience(s,
        ...
        [
            ...
            "<b>Tech Stack: React \u00b7 React Native \u00b7 TypeScript \u00b7 Redux Sagas \u00b7 Next.js \u00b7 "
            "Styled Components \u00b7 I18N \u00b7 OAuth</b>",
        ],
    )
    story.append(Spacer(1, 5))
    ...
    story += experience(s,
        ...
        [
            ...
            "for end users",
            "<b>Tech Stack: React \u00b7 TypeScript \u00b7 Redux Sagas \u00b7 Next.js \u00b7 D3.js \u00b7 "
            "SASS \u00b7 Atomic Design \u00b7 Big Data \u00b7 Unit Testing</b>",
        ],
    )
    story.append(Spacer(1, 5))
    ...
    story += experience(s,
        ...
        [
            ...
            "<b>Tech Stack: React \u00b7 React Native \u00b7 TypeScript \u00b7 PHP \u00b7 WordPress \u00b7 "
            "Cloudflare \u00b7 CI/CD \u00b7 Unit Testing \u00b7 AdWords \u00b7 SEO</b>",
        ],
    )
    story.append(Spacer(1, 5))
    ...
    story += experience(s,
        ...
        [
            ...
            "<b>Tech Stack: Angular \u00b7 Ruby on Rails \u00b7 PHP \u00b7 WordPress \u00b7 Java \u00b7 "
            "Android \u00b7 Cordova \u00b7 jQuery \u00b7 Heroku</b>",
        ],
    )
    ...
    for line in [
        "<b>Languages:</b> Spanish (Native), English (C1 \u2013 Fluent), Japanese (Basic)",
        "<b>Interests:</b> Anime culture | Traveling the world | Animal lover | Continuous learning",
        "<b>Front-End:</b> React.js | Next.js | React Native | Vue | Angular | Astro | TypeScript | "
        "JavaScript | Zustand | Redux | RTQ | TanStack Query | Tailwind CSS | Material UI | Mantine | "
        "Shadcn | Ant Design | HTML5 | CSS3 | SASS | PostCSS | D3.js | jQuery | Zod",
        "<b>Back-End:</b> Node.js | Express.js | NestJS | RESTful APIs | GraphQL | MongoDB | "
        "PostgreSQL | PHP | Ruby on Rails | Ruby | WordPress | Elixir",
        "<b>Testing:</b> Jest | Vitest | Cypress | Playwright | ESLint",
        "<b>DevOps:</b> CI/CD | GitHub Actions | Docker | AWS (EC2, S3, IAM) | Vercel | "
        "Heroku | Cloudflare",
        "<b>Architecture:</b> System Design | Atomic Design | Microservices | Monorepo (Nx, "
        "Turborepo) | Technical Leadership | Mentoring | Agile | Scrum",
        "<b>Tools & Platforms:</b> Git | Storybook | Builder.io | WordPress",
    ]:
