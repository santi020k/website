...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 504 80" role="img" aria-label="Santi020k">
  ...
  <text x="100" y="54" font-family="Montserrat, Inter, sans-serif" font-weight="800" font-size="48" fill="#faf9fb" letter-spacing="-0.04em">Santi<tspan fill="#5a0fdb" font-weight="600" letter-spacing="-0.02em">020k</tspan></text>
</svg>
`)
