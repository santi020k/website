...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3840 2160">
  ...
  <g transform="translate(1820, 980)">
    <!-- Logo Mark -->
    <rect width="200" height="200" rx="46" fill="#1b141f" stroke="#5a0fdb" stroke-width="4" />
    <path d="M 64 68 L 100 100 L 64 132" fill="none" stroke="#5a0fdb" stroke-width="16" stroke-linecap="round" stroke-linejoin="round" />
    <line x1="120" y1="132" x2="152" y2="132" stroke="#5a0fdb" stroke-width="16" stroke-linecap="round" />
  </g>
</svg>
`)
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3840 2160">
  <defs>
    <pattern id="grid3" width="80" height="80" patternUnits="userSpaceOnUse">
      <path d="M 80 0 L 0 0 0 80" fill="none" stroke="rgba(90,15,219,0.07)" stroke-width="2"/>
    </pattern>
  </defs>
  <rect width="3840" height="2160" fill="#1b141f" />
  ...
  <g transform="translate(2000, 300) scale(10)">
    <rect width="200" height="200" rx="46" fill="none" stroke="#5a0fdb" stroke-width="1" stroke-dasharray="8 8" opacity="0.3"/>
    <path d="M 64 68 L 100 100 L 64 132" fill="none" stroke="#5a0fdb" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" opacity="0.1" />
    <line x1="120" y1="132" x2="152" y2="132" stroke="#5a0fdb" stroke-width="4" stroke-linecap="round" opacity="0.1" />
  </g>
</svg>
`)
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1170 2532">
  <defs>
    <pattern id="grid3m" width="40" height="40" patternUnits="userSpaceOnUse">
      <path d="M 40 0 L 0 0 0 40" fill="none" stroke="rgba(90,15,219,0.07)" stroke-width="2"/>
    </pattern>
  </defs>
  <rect width="1170" height="2532" fill="#1b141f" />
