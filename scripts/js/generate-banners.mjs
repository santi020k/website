...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${WIDTH} ${HEIGHT}">
  ...
  <g transform="translate(${WIDTH / 2 - 252}, 140)">
    <!-- Logo Mark -->
    <rect width="116" height="116" rx="26" fill="#6319be" />
  ...
  <!-- Wordmark -->
  <text x="${WIDTH / 2 - 100}" y="222" font-family="Montserrat, Inter, sans-serif" font-weight="800" font-size="72" fill="#332e38" letter-spacing="-0.04em">Santi<tspan fill="#6319be" font-weight="600" letter-spacing="-0.02em">020k</tspan></text>
</svg>
`)
