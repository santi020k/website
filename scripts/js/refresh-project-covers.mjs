/* eslint-disable func-style, no-use-before-define, @stylistic/max-len, no-nested-ternary -- TODO: Refactor the generated cover refresh pipeline into typed lookup helpers and smaller drawing modules so these safety/style rules can be re-enabled. */
