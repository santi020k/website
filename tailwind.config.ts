    ...
    plugin(({ addComponents }) => {
      addComponents({
        ...
        '.data-footnote-backref': {
          ...
          '@apply inline-flex bg-accent-two text-xs h-4 w-4 rounded-sm items-center justify-center':
            {}
        }
      })
    })
      ...
      typography: (theme: any) => ({
        DEFAULT: {
          css: {
            ...
            kbd: {
              '@apply bg-special-lighter border-color-100 shadow-[0px_2.5px_0px_rgba(0,0,0,0.25)]':
                ''
            },
            hr: {
